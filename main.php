...
<html>
  <head>
    <meta charset="UTF-8">
    <title>BAPER || Aplikasi Barang dan Persediaan</title>
  ...
  <body class="skin-blue fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="?module=home" class="logo">BAPER</a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2021 by SenopaTEA - <a href="https://desablockchain.com" target=_blank>desablockchain.com</a></strong>
      </footer>
    </div><!-- ./wrapper -->
