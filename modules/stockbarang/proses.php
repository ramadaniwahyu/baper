    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            if ($query) {
                ...
                header("location: ../../main.php?module=stockbarang&alert=1");
            }   
        }   
    }
        ...
        if (isset($_POST['simpan'])) {
            if (isset($_POST['id_barang'])) {
                ...
                if ($query) {
                    ...
                    header("location: ../../main.php?module=stockbarang&alert=2");
                }         
            }
        }
    }
    ...
    elseif ($_GET['act']=='delete') {
        if (isset($_GET['id'])) {
            ...
            if ($query) {
                ...
                header("location: ../../main.php?module=stockbarang&alert=3");
            }
        }
    }       
}       
