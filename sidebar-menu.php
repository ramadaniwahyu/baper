...
if ($_SESSION['hak_akses']=='Super Admin') { ?>
	...
	if ($_GET["module"]=="permintaan_barang" || $_GET["module"]=="form_permintaan_barang") { ?>
		<li class="active treeview">
          	<a href="javascript:void(0);">
            	<i class="fa fa-clone"></i> <span>Transaksi</span> <i class="fa fa-angle-left pull-right"></i>
          	</a>
      		<ul class="treeview-menu">
				<li class="active"><a href="?module=permintaan_barang"><i class="fa fa-circle-o"></i> Permintaan Barang</a></li>
	...
	if ($_GET["module"]=="barang_masuk" || $_GET["module"]=="form_barang_masuk") { ?>
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
				<li><a href="?module=permintaan_barang"><i class="fa fa-circle-o"></i> Permintaan Barang</a></li>
